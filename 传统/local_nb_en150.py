...
def readDataSet():
    ...
    label = []
    content = []
    with open("/home/ubuntu/ys-180326/Dataset150.csv","r",encoding='UTF-8') as csvFile:
...
def local(train_comment, train_label, test_comment, test_label, clf):
    ...
    print(metrics.precision_score(test_label, predicted))
...
if __name__ == '__main__':
    #corpus_segment('C:\\Users\\MyPC\\Desktop\\test\\AMAZON_Negative_4000.txt','C:\\Users\\MyPC\\Desktop\\test\\AMAZON_Negative_4000_cut.txt')
    ...
    local(train_comment , train_label , test_comment ,test_label, gnb)
